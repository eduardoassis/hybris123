...
public class DefaultPaginatedFlexibleSearchServiceIntegrationTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldNotFailWithOverTheLimitPages()
	{
		...
		final Map<String, String> sortMap = new LinkedHashMap();
		sortMap.put(UserGroupModel.UID, SearchConstants.ASCENDING);
		SearchPageData searchPageData = PaginatedSearchUtils.createSearchPageDataWithPaginationAndSorting(pageSize, currentPage, needsTotal, sortMap);
		parameter.setSearchPageData(searchPageData);
		...
		//then
		assertPaginationResults(0, 6, 1, pageSize, currentPage, 3, searchResult);
	}
	@Test
	public void shouldNotFailWithOverTheLimitPagesAndNoTotal()
	{
		...
		//then
		assertPaginationResults(0, 0, 1, pageSize, currentPage, 0, searchResult);
	}
	...
	public void shouldNotFailWithNoPages()
	{
		...
		//then
		assertPaginationResults(0, 6, 1, pageSize, 0, 0, searchResult);
	}
	...
	public void shouldNotFailWithNoPagesAndNoTotal()
	{
		...
		//then
		assertPaginationResults(0, 0, 1, pageSize, 0, 0, searchResult);
	}
	...
	public void shouldSearchWithoutTotal()
	{
		...
		//then
		assertPaginationResults(2, 2, 1, pageSize, currentPage, 1, searchResult);
	}
	...
	protected void assertPaginationResults(final int expectedPaginatedResultSize,
										   final int expectedTotalResultSize,
										   final int expectedSortSize,
