 ...
 */
package br.com.carrefour.marketplaceoutws.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import br.com.carrefour.marketplaceoutws.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "marketplaceoutws.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "marketplaceoutws.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "marketplaceoutws.oauth2.tokenUrl";

	private static final String DESC = "marketplaceoutws.v1.description";
	private static final String TITLE = "marketplaceoutws.v1.title";
	private static final String VERSION = "marketplaceoutws.v1.version";
